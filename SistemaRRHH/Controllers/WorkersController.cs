...
namespace SistemaRRHH.Controllers
{
    public class WorkersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,FirstName,LastName,BirthDay,WorkerID,PlaceOfBirth,Address,CivilStatus,Profession,Status,Salary,StartDate,EndDate,Position")] Worker worker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,FirstName,LastName,BirthDay,WorkerID,PlaceOfBirth,Address,CivilStatus,Profession,Status,Salary,StartDate,EndDate,Position")] Worker worker)
        {
            if (id != worker.id)
            {
                return NotFound();
